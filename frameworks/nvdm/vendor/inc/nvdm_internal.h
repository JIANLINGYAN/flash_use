...
typedef struct {
    ...
    uint8_t status;          /* offset: 8, len: 1; status of PEB (peb_status_t) */
...
typedef struct {
    uint8_t status;                 /* offset: 0, len: 1; status of data item (data_item_status_t)*/
    ...
    uint8_t type;                   /* offset: 11, len: 1; display type of data item,
                                                           it can be type of binary/hex/decimal/string/structure (nvdm_data_item_type_t) */
